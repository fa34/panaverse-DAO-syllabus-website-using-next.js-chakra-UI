...
<Box  bg={"#B2F5EA"}>
<Heading textAlign={"center"} size='md'>Ambient Computing and IoT Specialization</Heading>
<br />
...
<CardHeader>
  ...
  <Center>
    <Heading size={"sm"}>
    Course Name: AC-351: Ambient Computing with Voice Assistants and Matter Devices
    </Heading>
  </Center>
  <Center> <Text pt='2' fontSize='sm'>
Duration: 13 Weeks
...
<CardBody>
  <Stack divider={<StackDivider />} spacing='4'>
    <Box>
    <li>Course Description: This course focuses on the concept of ambient computing, which is the idea of embedding computing power into our everyday lives in a way that is invisible but useful. Students will learn how to build smart homes with Amazon Alexa and the Matter protocol, which is the next-generation smart home standard. The course will cover Alexa skill development and integration with Matter devices.</li>
<li>Course Outline: 
<ul>
<li>Alexa Skill Development - https://developer.amazon.com/en-US/alexa</li>
<li>Alexa with Matter Protocol - https://developer.amazon.com/en-US/alexa/matter, https://developer.amazon.com/en-US/blogs/alexa/device-makers/2022/07/alexa-live-2022-ack-sdk-matter.html</li>
</ul>
</li>
...
<CardBody>
  <Stack divider={<StackDivider />} spacing='4'>
    <Box>
    <li>Course Description: This is an introductory course on using C and Rust programming languages for "Bare Metal" embedded systems like microcontrollers. Topics include basic programming concepts, electronics, microcontrollers, and embedded programming. </li>
<li>Course Outline:
<ul>
<li>Weeks 1-2: Introduction to the Internet of Things and Embedded Systems</li>
<li>Weeks 3B-5: Introduction to C Part 1</li>
<li>Weeks 6-7: C Programming Part 2</li>
<li>Week 8: Introduction to Embedded Systems Part 1</li>
<li>Weeks 9-12: Introduction to Embedded Systems Part 2</li>
<li>Extra Weeks: Embedded Programming using Rust</li>
</ul>
</li>
<li>Hardware Requirements: Esp8266 (Node MCU), jumper wires, breadboard, LEDs, sensors (Dht11, ultrasonic sensor, IR sensor)</li>
