...
<Box  bg={"#B2F5EA"}>
<Heading textAlign={"center"} size='md'>Cloud-Native Computing Specialization</Heading>
<br />
...
<p>Kubernetes is an open-source system for automating the deployment, scaling, and management of containerized applications. In this course, you will learn how to develop cloud applications using cloud-native technologies like Containers, Kubernetes, and CDK for Kubernetes.</p>
<li>Course Outline:</li>
<ul>
<li>Kubernetes: Up and Running: Dive into the Future of Infrastructure 3rd Edition<br />https://www.amazon.com/Kubernetes-Running-Dive-Future-Infrastructure/dp/109811020X/ref=sr_1_3</li>
<li>Cloud Development Kit for Kubernetes<br />https://cdk8s.io/</li>
</ul>
...
<CardBody>
  <Stack divider={<StackDivider />} spacing='4'>
    <Box>
    <li>CDK for Terraform: <a href="https://developer.hashicorp.com/terraform/cdktf">https://developer.hashicorp.com/terraform/cdktf</a></li>
